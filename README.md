...
[在线体验](https://purryc.github.io/interactive-pet/) · [完整交互与物理规格 PRD](PRD.md) · [完整动作预览](output/siamese_cat_quadruped_v10.mp4)
...
- **逗猫棒（默认）**：Apple Pencil 悬停或移动鼠标。Pencil 本身是杆身，屏上短棒头随笔的倾角与方位改变系绳点；绳、球和羽片随后摆动并碰撞猫与地面。Heihei 按距离、高度与速度决定行动；球在左右两侧时用对应的前爪，中线附近轮流伸爪，动作进行时头颈仍追踪可见的球。高度滑块只模拟网页拿不到的离屏高度。观察、零食、视角、动作、参数和记录都在右上角「设置」里。
